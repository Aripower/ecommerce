<?php
class PagSeguro{
	private $email         = "red.crucible.test@gmail.com";
	private $token_sandbox = "738E40FB9EEA428189934BBDFFCA8A21";
	private $token_oficial = "TOKEN DO PAGSEGURO";
	private $url_retorno   = "http://localhost/php_work/Exercicio/carrinho.php";
